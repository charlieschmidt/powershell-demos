import-module module1 -force
import-module module2 -force

write-host 'Basic original test'
Remove-Variable -Name "Dynamic" -Force -ErrorAction SilentlyContinue
$DynamicExists = $null -ne (Get-Variable Dynamic -ErrorAction SilentlyContinue)
if ($DynamicExists -eq $true)
{
    write-warning "$Dynamic exists in Testing.ps1 scope!"
}
write-host "call Test-DynamicParam with the module version of New-DynamicParameter found in Module1"
Test-DynamicParam -StaticRequired "the static" -Dynamic "Valid1" -Verbose
$DynamicExists = $null -ne (Get-Variable Dynamic -ErrorAction SilentlyContinue)
if ($DynamicExists -eq $true)
{
    write-warning "$Dynamic exists in Testing.ps1 scope!"
...
write-host ''
write-host 'Test with embedded version'
Remove-Variable -Name "Dynamic" -Force -ErrorAction SilentlyContinue
$DynamicExists = $null -ne (Get-Variable Dynamic -ErrorAction SilentlyContinue)
if ($DynamicExists -eq $true)
{
...
write-host "call Test-DynamicParam with the embedded version of New-DynamicParameter found in Testing.ps1"
Test-DynamicParam -StaticRequired "the static" -Dynamic "Valid1" -Verbose
$DynamicExists = $null -ne (Get-Variable Dynamic -ErrorAction SilentlyContinue)
if ($DynamicExists -eq $true)
{
...
write-host ''
write-host 'Test with module version and Scope=2'
Remove-Variable -Name "Dynamic" -Force -ErrorAction SilentlyContinue
$DynamicExists = $null -ne (Get-Variable Dynamic -ErrorAction SilentlyContinue)
if ($DynamicExists -eq $true)
{
...
write-host "call Test-DynamicParamInScope2 with the module version of New-DynamicParameterInScope2 found in Module1"
Test-DynamicParamInScope2 -StaticRequired "the static" -Dynamic "Valid1" -Verbose
$DynamicExists = $null -ne (Get-Variable Dynamic -ErrorAction SilentlyContinue)
if ($DynamicExists -eq $true)
{
    write-warning "$Dynamic exists in Testing.ps1 scope!"
